...
class GeradorArquivoOBN {
  ...
  private function constroiLinhaTrailer() {
    ...
    $oStdLinhaTrailer->somatorio_valores             = str_pad(str_replace(".", "", number_format($this->nValorTotalDasMovimentacoes, 2, ".", "")), 17, "0", STR_PAD_LEFT);
    /* Fim Plugin ArquivoOBNGRU - Parte9 */
