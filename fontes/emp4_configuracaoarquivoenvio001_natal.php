...
function js_incluirDetalhe(iMovimento){
  ...
  if (iFatura == '1' || iFatura == '2') {
    ...
    if (iCodReceita == '') {
      ...
      alert('Obrigatório preenchimento do campo do Código da Receita do Tributo.');
      $('txtCodReceita').focus();
      return false;
    }
    if (iCodIdent == '') {
      
      alert('Obrigatório preenchimento do campo do Código de Identificação do Tributo.');
      $('txtCodIdent').focus();
      return false;
    }
  }
  ...
  if (dtPeriodoApuracao == '') {
    ...
    if (iFatura == '4' || iFatura == '5') {
      ...
      alert('Obrigatório preenchimento do período de apuração.');
      return false;
    } else {
...
function js_viewConfiguracao (iCodMov) {
    ...
    var sConteudoDetalhes  = "<div>";
      ...
      sConteudoDetalhes += "              </td>   ";
      sConteudoDetalhes += "              <td >   ";
      sConteudoDetalhes += "               <strong> Cód. Ident. Tributo: </strong>  ";
      sConteudoDetalhes += "              </td>  ";
      sConteudoDetalhes += "              <td align='left'>   ";
      ...
      sConteudoDetalhes += "      <td >   ";
      sConteudoDetalhes += "       <strong> Mês/Ano Competência: </strong>  ";
      sConteudoDetalhes += "      </td>  ";
      sConteudoDetalhes += "      <td align='left'>   ";
      ...
      sConteudoDetalhes += "        <td>    ";
      sConteudoDetalhes += "          <strong> Num. Referência: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
      ...
      sConteudoDetalhes += "        <td >   ";
      sConteudoDetalhes += "         <strong> Atualização Monetária: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
      ...
      sConteudoDetalhes += "        <td >   ";
      sConteudoDetalhes += "         <strong> Período Apuração: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
